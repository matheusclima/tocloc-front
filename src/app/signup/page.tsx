        ...
        <div className="min-h-screen bg-gray-900 flex items-center justify-center">
            <div className="flex items-center p-4 bg-white rounded-xl w-3/5 ">
                ...
                <div className="bg-white pl-4 rounded-lg max-w-md w-full">
                    <Link href="/" className="text-gray-800 flex items-center mb-6 ">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input type="text" id="name" name="name"
                                className="w-full h-12 text-black px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
                        </div>
                        <div className="mb-4">
                        ...
                        <button type="submit" className="w-full bg-blue-900 text-white py-2 rounded-lg hover:bg-blue-800">Confirmar</button>
                    </form>
